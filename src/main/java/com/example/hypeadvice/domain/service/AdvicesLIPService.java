...
public class AdvicesLIPService {
            ...
            try {
                ...
                if (body.contains("No advice slips found matching that search term")) {
                    throw new RuntimeException(
                            "Status Code" + status + ", message: No advice slips found matching that search term");
                }
    ...
    public AdviceVO buscarById(String id) throws UnirestException {
        ...
        if (HttpStatus.SC_OK == status) {
            ...
            try {
                ...
                if (body.contains("Advice slip not found.")) {
                    throw new RuntimeException(
                            "Status Code" + HttpStatus.SC_NOT_FOUND + ", message: Não encontramos esse registro");
                }
